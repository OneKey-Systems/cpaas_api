...
public class ConferenceBuilder {
    ...
    /**
     * URL where some parameters specific to {@code <Conference>} will be sent when participants enter and exit the
     * conference and once it is completed. There is only one callbackUrl allowed per conference. The first callbackUrl
    ...
    /**
     * URL to inboundXML where conference participants can be sent to while they wait for entrance into the conference.
     * Only {@code <Play>} method supported at this time.
     * @param waitSound
     * @return
     */

...
public interface CallsProxy {
    ...
    Response makeCall(
            ...
            @FormParam("Method") mx.onekey.dev.cpaas.api.domain.enums.HttpMethod method,
            @FormParam("FallbackUrl") String fallbackUrl,
            @FormParam("FallbackMethod") mx.onekey.dev.cpaas.api.domain.enums.HttpMethod fallbackMethod,
            ...
            @FormParam("RecordCallbackMethod") mx.onekey.dev.cpaas.api.domain.enums.HttpMethod recordCallbackMethod,
            ...
            @FormParam("IfMachineMethod") mx.onekey.dev.cpaas.api.domain.enums.HttpMethod ifMachineMethod,

...
import mx.onekey.dev.cpaas.api.restproxies.SipCredentialsProxy;
...
public class SipCredentialsConnector extends BaseConnector {
     ...
     * @throws ZangException
     */
    public mx.onekey.dev.cpaas.api.domain.list.CredentialsList listCredentials(String accountSid, String credentialsListSid, Integer page, Integer pageSize) throws ZangException {
        return returnThrows(proxy.listCredentials(accountSid, credentialsListSid, page, pageSize), mx.onekey.dev.cpaas.api.domain.list.CredentialsList.class);
    }
     ...
     * @throws ZangException
     */
    public mx.onekey.dev.cpaas.api.domain.list.CredentialsList listCredentials(String credentialsListSid, Integer page, Integer pageSize) throws ZangException {

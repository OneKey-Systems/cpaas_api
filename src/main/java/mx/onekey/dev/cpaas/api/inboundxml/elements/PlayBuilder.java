...
public class PlayBuilder {
    ...
    /**
     * The amount of times the {@code <Play>} should be repeated. 0 indicates an infinite loop. The default value is 1.
     * Allowed values are integers greater than or equal to 0.
     * @param loop
     * @return
     */

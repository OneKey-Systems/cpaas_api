...
import mx.onekey.dev.cpaas.api.inboundxml.elements.enums.SamplingRate;
...
public class RecordBuilder {
    ...
    /**
     * URL where some parameters specific to {@code <Record>} will be sent for further processing.
     * @param action
     * @return
     */
    ...
    /**
     * The number of seconds {@code <Record>} should wait during silence before ending. Default timeout value is 5
     * seconds. Valid value is integer greater than or equal to 0.
     * @param timeout
     * @return
     */
    ...
    /**
     * The key a caller can press to end the {@code <Record>}. Default value is #. Allowed values are digits from 0 to 9, # or *.
     * @param finishOnKey
     * @return
     */

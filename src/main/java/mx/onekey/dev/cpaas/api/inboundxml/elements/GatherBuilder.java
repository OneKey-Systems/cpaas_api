...
import mx.onekey.dev.cpaas.api.inboundxml.elements.enums.BCPLanguage;
import mx.onekey.dev.cpaas.api.inboundxml.elements.enums.GatherInput;
...
public class GatherBuilder {
	...
	/**
	 * The number of seconds {@code <Gather>} should wait for digits to be entered before
	...
	/**
	 * The key a caller can press to end the {@code <Gather>}. Default value is #.
	...
	/**
	 * The maximum number of digits to {@code <Gather>}. Default value is set to no limit.
